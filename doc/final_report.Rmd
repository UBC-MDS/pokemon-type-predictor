...
```{r, fig.cap='Figure 1. Correlation table between all features in the dataset', out.width='90%'}
...
```{r, fig.cap='Figure 2. Confusion matrix visualizing the dummy classifier predictions vs the true labels.', out.width='90%'}
...
```{r, fig.cap='Figure 3. Confusion matrix visualizing predictions from the best k-NN model vs the true labels.', out.width='90%'}
...
```{r, fig.cap='Figure 4. Confusion matrix visualizing predictions from the best SVC model vs the true labels.', out.width='90%'}
